class RAGRunner:
    ...
    async def astream_run(self, prompt: str, top_k: int = 5, top_m: int = 2):
        """
        Executes the full GraphRAG pipeline to answer a prompt and streams the response.
        """
        print(f"\n--- Running Streaming GraphRAG pipeline for prompt: '{prompt}' ---")
        ...
        print("--- Streaming GraphRAG pipeline complete. ---")